 ...
 const app = vue.createApp({
    data() {
        return{
            ...
            winner: null,
            battleLogMessage: [],
            swordSlash: new Audio('assets/sounds/sword_slash.mp3'),
            dragonBreath: new Audio('assets/sounds/dragon_breath.mp3'),
            healEffect: new Audio('assets/sounds/heal_effect.mp3'),
            specialAttackEffect: new Audio('assets/sounds/special_attack.mp3'),
        }
    },
    watch: {
        warriorHealth(value){
